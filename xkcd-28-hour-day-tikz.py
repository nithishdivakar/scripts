...
sleep_offset = 10 #sleep time offset
...
sleep = [(0,4),(14,19),(29,34),(42,46),(56,60),(70,74)]
...
print("\draw   ({:2.2f},{:2.2f}) rectangle ({:2.2f},{:2.2f});".format(0,0,l+L+L,h+H+H))
print("\draw   ({:2.2f},{:2.2f}) rectangle ({:2.2f},{:2.2f});".format(L,H,L+l,H+h))
